          ...
          <div className="flex flex-col gap-6 lg:gap-8 h-full">
            ...
            <div className="bg-[#1F1F1F] rounded-[25px] p-6 lg:p-8 flex flex-col shadow-xl">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <button data-enquiry-trigger="true" data-track data-track-event="popup_form_click" data-track-text="Apply Now" data-track-header="Your faculty. Your future." className="bg-[#0CAADD] text-white px-6 py-3 rounded-full font-poppins text-[14px] font-semibold hover:bg-opacity-90 transition-opacity whitespace-nowrap">Apply Now</button>
                <a 
                ...
                <a 
                  ...
                  className="bg-[#E73649] text-white px-6 py-3 rounded-full font-poppins text-[14px] font-semibold hover:bg-opacity-90 transition-opacity flex items-center gap-2 whitespace-nowrap"
                >

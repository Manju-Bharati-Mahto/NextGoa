export function CampusLifeHero() {
  return (
    <section className="relative w-full min-h-screen bg-white flex items-center overflow-hidden">
      <div className="mx-auto w-full max-w-7xl px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-0 py-24 lg:py-0">

        {/* ── Left: Text ── */}
        <div className="flex-1 lg:pr-8 z-10 lg:-translate-x-[150px]">
          {/* Eyebrow pill */}
        ...
        {/* ── Right: Collage ── */}
        <div className="flex-1 flex items-center justify-center relative min-h-[520px] lg:min-h-[600px] lg:translate-x-[50px]">
          <img
            src="/campus-life/hero-collage.png"
            alt="Campus Life"
            className="w-full h-auto max-w-[750px] lg:max-w-[950px] scale-110 lg:scale-125 origin-center object-contain relative z-20"
          />
        </div>
      </div>
    </section>

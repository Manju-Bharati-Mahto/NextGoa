    ...
    <section className="overflow-hidden bg-brand-white py-10 sm:pt-18">
      <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
        <div className="text-left">
          <p className="text-ink section-subheading">{data?.eyebrow}</p>
          <h2
            className="mt-4 text-brand section-heading max-w-5xl"
            ...
            {milestones.map((item: any, index: number) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute left-1/2 w-[2px] bg-brand-blue-guideline/30 transition-all duration-300 group-hover/card:bg-brand/60 ${
                  ...
                  {/* Milestone Card */}
                  <div
                    className={`absolute left-1/2 -translate-x-1/2 w-[260px] sm:w-[290px] bg-white rounded-[20px] p-6 sm:p-7 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-black/5 transition-all duration-500 group-hover/card:shadow-[0_12px_40px_rgb(0,0,0,0.12)] ${
                      isEven
                  ...
                  >
                    ...
                    <div
                      className={`absolute left-1/2 -translate-x-1/2 w-4 h-4 bg-white border-black/5 transform rotate-45 ${
                        isEven
                          ? "bottom-[-8.5px] border-b border-r"

    ...
    >
      ...
      <div className="flex flex-col z-10 relative">
        ...
        <div className="flex flex-wrap gap-1 sm:gap-1.5 mb-1.5 sm:mb-3">
          ...
          {tags.length > 2 && (
            <span
              className={`font-poppins inline-flex items-center justify-center rounded-full px-2.5 py-1 text-[10px] font-bold ${theme.tag} sm:hidden`}
            >
              +{tags.length - 2}
            </span>
          )}
...
export function ProgrammeFinder({ data }: Props) {
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        ...
        >
          <div className="flex flex-1 items-center">
            ...
            >
              <option value="" className="py-3 px-4 text-base">
                I am exploring
              </option>
              {levels.map((l) => (
        ...
        {displayedFaculties.length === 0 ? (
          <div className="mt-12 text-center py-16 px-6 rounded-3xl border border-zinc-200 max-w-xl mx-auto bg-white shadow-sm">
            ...
            <h3 className="mt-5 text-lg font-semibold text-ink font-poppins">
              No programmes found
            </h3>
            <p className="mt-2 text-sm text-ink/70">
              We couldn&apos;t find any faculties offering{" "}
              <strong>{level}</strong> programmes in the{" "}

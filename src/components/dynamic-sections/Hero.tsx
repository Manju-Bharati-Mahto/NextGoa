    ...
    >
      ...
      <div className={wrapperClass} style={textStyle}>
        <h1 className="font-[family-name:var(--font-poppins)] mx-auto w-full max-w-none text-4xl font-bold leading-[1.05] tracking-tight text-ink sm:text-5xl lg:text-[3.5rem] lg:whitespace-nowrap">
          {data.title}
          <br />
          <span className="text-brand">{data.headingHighlight}</span>
        </h1>
        <p
          className="mx-auto mt-6 max-w-2xl text-sm font-medium text-ink sm:text-lg"
        ...
        <a
          ...
          className="mt-8 inline-block rounded-full bg-sunshine px-6 py-2 text-sm font-bold text-ink shadow-sm"
        >
          {data.buttonText}
        </a>
      </div>
      ...
      <div
        className={`${logoWrapperClass} pointer-events-none`}
        style={logoStyle}
      >
        <img
          src="/hero-logo.svg"

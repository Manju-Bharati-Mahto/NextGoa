...
export function StatsBar({ data, }: StatsBarProps) {
  return (
   <section
  id="stats"
  className="bg-ink-warm py-8 sm:py-5"
>
  <div className="mx-auto max-w-7xl px-6 py-8 sm:py-25">

    <dl className="grid grid-cols-1 gap-14 sm:grid-cols-3 sm:gap-6 sm:divide-x sm:divide-white/10">
      ...
      {data.items?.map((item, index) => (
        ...
        >
          ...
          <dt className="font-[family-name:var(--font-gotham)] text-6xl sm:text-[80px] sm:leading-none font-bold tracking-tight text-brand-bright">
          ...
          <dd className="mt-2 text-lg sm:text-xl font-medium text-white/70">
    ...
    {data.footer && (
      ...
      <p
        className="mt-10 text-center text-base sm:text-sm text-white/40"

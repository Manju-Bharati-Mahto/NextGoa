        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1.7fr_0.95fr_0.95fr_1.08fr] lg:gap-16">
          ...
          <div className="max-w-[34rem]">
            ...
            <div className="mt-8 flex items-center gap-5">
              ...
              <a href="https://www.youtube.com/@ParulUniversity" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full text-white bg-[#e73649] transition-colors" aria-label="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">

...
export default function RecruitersAndDestinations({ hideDestinations = false }: { hideDestinations?: boolean } = {}) {
  return (
    <section className="w-full bg-[#FAFAFA] py-20 overflow-hidden border-t border-gray-100">
      ...
      {/* Marquee Section */}
      <div className={`w-full bg-transparent py-8 ${hideDestinations ? 'mb-0' : 'mb-20'} overflow-hidden relative`}>
        {/* Faded Top Border */}

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-fr">
          ...
          <div className="lg:col-span-2 rounded-2xl bg-[#0EB1E1] p-8 relative overflow-hidden flex flex-col justify-center min-h-[200px]">
            ...
            <div className="absolute bottom-3 -right-5 flex items-center pointer-events-none">
              <img src="/abroad/Knowledge Beacon.svg" alt="Partner Logo" className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-[4px] border-white bg-white z-10 shadow-sm object-cover translate-y-4" />
              <img src="/abroad/Global Academic Partner.svg" alt="Partner Logo" className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-[4px] border-white bg-white -ml-8 sm:-ml-10 z-20 shadow-sm object-cover -translate-y-4" />
              <img src="/abroad/The University of Waikato.svg" alt="Partner Logo" className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-[4px] border-white bg-white -ml-8 sm:-ml-10 z-30 shadow-sm object-cover translate-y-4" />
              <img src="/abroad/Charles Sturt University.svg" alt="Partner Logo" className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-[4px] border-white bg-white -ml-8 sm:-ml-10 z-40 shadow-sm object-cover -translate-y-4" />
              <img src="/abroad/Global Education Partner.svg" alt="Partner Logo" className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-[4px] border-white bg-white -ml-8 sm:-ml-10 z-50 shadow-sm object-cover translate-y-4" />
            </div>
          </div>

    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full flex flex-col md:flex-row gap-5 mb-12 justify-center z-10">
          ...
          {/* Card 1 */}
          <div className="bg-white rounded-2xl p-6 md:p-8 flex flex-col justify-between w-full md:w-1/2 max-w-lg shadow-lg min-h-[200px]">
            <div>
          ...
          {/* Card 2 */}
          <div className="bg-[#fbdc2a] rounded-2xl p-6 md:p-8 flex flex-col justify-between w-full md:w-1/2 max-w-lg shadow-lg min-h-[200px]">
            <div>

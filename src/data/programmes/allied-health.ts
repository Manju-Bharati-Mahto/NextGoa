...
export const alliedHealthData: ProgrammeData = {
  ...
  labs: {
    ...
    features: [
      { title: "Pathology Lab", description: "Fully functional setup for hematology and biochemistry tests." },
      { title: "Mock OT", description: "Simulated operation theater for training in surgical assistance." },
      { title: "Radiology Suite", description: "Training setups for X-ray, Ultrasound, and basic MRI principles." }
    ],

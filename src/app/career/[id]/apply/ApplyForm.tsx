  ...
  return (
    <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col gap-2">
        ...
        <input required type="text" className="border border-gray-200 rounded-xl px-4 py-3 bg-[#FAFAFA] focus:outline-none focus:border-gray-400 transition-colors text-[15px] placeholder-gray-400" placeholder="Select Position" />
      </div>

      {/* Specialisation */}
      <div className="flex flex-col gap-2">
        <label className="text-[15px] font-bold text-[#111111]">Specialisation</label>
        <input required type="text" className="border border-gray-200 rounded-xl px-4 py-3 bg-[#FAFAFA] focus:outline-none focus:border-gray-400 transition-colors text-[15px] placeholder-gray-400" placeholder="Select Specialisation" />
      </div>
      ...
      <div className="md:col-span-2 mt-5">
        <label className="border-2 border-dashed border-[#EF3341] rounded-[20px] px-4 py-14 bg-[#EAF6FA] flex flex-row items-center justify-center cursor-pointer hover:bg-[#E1F0F8] transition-colors w-full block">
          <div className="flex flex-row items-center justify-center">
            ...
            <span className="text-[#6B7A90] font-bold text-[16px]">Upload Resume</span>
          </div>
          <input required type="file" accept=".pdf,.doc,.docx,application/pdf" className="hidden" />
        </label>
      </div>

...
export default function NotFound() {
  return (
    <main className="h-screen w-full bg-[#FFD523] flex flex-col pt-[10vh] overflow-hidden font-[family-name:var(--font-poppins)] relative">
      <HideFooter />
      <div className="flex flex-col items-center md:items-start text-center md:text-left z-10 px-8 md:px-16 lg:px-24 xl:px-32 mt-[100px] relative w-full">
        <h1 
      ...
      <div className="absolute right-0 bottom-0 w-[150%] sm:w-[120%] md:w-[80%] lg:w-[70%] xl:w-[60%] max-w-[1300px] z-0 pointer-events-none">
        <Image
